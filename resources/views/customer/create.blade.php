...
@section('contents')
    ...
    ?>
    {!! Form::open(array('url' => 'customers/create', 'class' => 'form-horizontal row-border','id'=>'validate-form'),$rules) !!}
            ...
            <div class="widget box">
                ...
                <div class="widget-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::text('customer_name',old('customer_name'),array('id'=>'ac_name','class'=>'form-control')) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::textarea('customer_address',old('customer_address'),array('id'=>'customer_address','class'=>'form-control')) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::text('contact_person',old('contact_person'),array('id'=>'contact_person','class'=>'form-control')) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::text('rm',old('rm'),array('id'=>'rm','class'=>'form-control')) !!}
