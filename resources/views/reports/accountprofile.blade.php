...
if( count($crp->customer->accountprofile) !=0)
{
    $apprequest =1;

    $borrowerid=$crp->customer->accountprofile->borrowerid;
    $credit_rating=$crp->customer->accountprofile->credit_rating;
    $legal_entity=$crp->customer->accountprofile->legal_entity;
    $business_activity =$crp->customer->accountprofile->business_activity;
    $g_indicator =$crp->customer->accountprofile->g_indicator;
    $group =$crp->customer->accountprofile->app_group;
    $emanagement =$crp->customer->accountprofile->emanagement;
    $cr_bankers =$crp->customer->accountprofile->borrowerid;
    $shareholders =$crp->customer->shareholders;
    $directors =$crp->customer->directors;
    $cr_bankers =$crp->customer->currentbankers;
    $id= $crp->customer->accountprofile->id;
}
