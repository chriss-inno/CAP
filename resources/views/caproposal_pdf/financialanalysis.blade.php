...
@if( $apprequest ==1)
    ...
    <div class="container" style="border: 1px solid #ddd; font-family: ta">


        <div class="row">
            <div class="col-md-12" style="text-align:center; background-color: #EEEEEE ">(C)  FINANCIAL ANALYSIS</div>
