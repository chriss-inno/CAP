...
@section('breadcrumbs')
    ...
    <li>
        <i class="icon-home"></i>
        <a href="{{url('committee')}}"> Management  Credit Committee</a>
    </li>
...
@section('contents')
    {!! Form::open(array('url' =>url('committee'), 'class' => 'form-horizontal row-border','id'=>'FileUploader')) !!}
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" value="{{old('firstname')}}" name="firstname" class="form-control" placeholder="Enter full name" required="required">
